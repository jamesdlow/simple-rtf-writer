...
/**
 * TestComplexRtfTemplate - Füllt die Felder eines bestehenden RTF Formulars. Das RTF Formular ist mit Word 97/2002
 * erstellt worden und mit Formularfeldern, sowie einer Textmarke bestückt worden. An der Textmarke wird
 * durch dieses Programm eine Aufzählungsliste mit verschiedenen Schriften eingefügt.
 *
...
public class TestComplexRtfTemplate {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Bemerkung hinzufügen; Textmarke
            ...
            listabsatz.addText(new TextPart(TextPart.FORMAT_NORMAL, 12, Font.ARIAL, "Schrift 'Arial' in Größe 12"));
            listabsatz.addText(new TextPart(TextPart.FORMAT_NORMAL, 14, Font.TIMES_NEW_ROMAN, "Schrift 'Times New Roman' in Größe 14"));
            listabsatz.addText(new TextPart(TextPart.FORMAT_NORMAL, 10, Font.COURIER_NEW, "Schrift 'Courier New' in Größe 10"));
            listabsatz.addText(new TextPart(TextPart.FORMAT_NORMAL, 8, Font.SYMBOL, "Schrift 'Symbol' in Größe 8"));
